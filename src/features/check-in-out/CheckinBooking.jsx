...
function CheckinBooking() {
  ...
  if (fetchBooking || loadSetting) return <Spinner />;
  ...
  //console.log(guests, totalPrice, numGuests, numNights, hasBreakfast);
      ...
      {!hasBreakfast && (
        <Box>
          <Checkbox
            ...
            id="breakfast">
            {guests.fullName} will add breakfast breakfast price{" "}
