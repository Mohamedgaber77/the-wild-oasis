...
function DurationChart({ stays, numDays }) {
  ...
  const tooltip = darkMode ? "#18212f" : "#fff";
  const tttext = darkMode ? "#e5e7eb" : "#374151";
  return (
    <ChartBox>
      <Heading as="h2">
        Stay Duration Chart Between {format(allDates.at(0), "MMM dd yyy")}{" "}
